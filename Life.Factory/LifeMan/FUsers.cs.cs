...
namespace Life.Factory.LifeMan
{
    public interface FUsers
    {
        ...
        /// <returns>数据集合</returns>
        List<Users> Select(int pageSize, int start, HashTableExp hash, out int total,String sqlWhere);
        ...
        /// </summary>
        /// <returns></returns>
        List<Users> Select(HashTableExp hash,String sqlWhere);
    }
}
