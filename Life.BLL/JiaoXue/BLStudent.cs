...
namespace Life.BLL.LifeMan
{
    ...
    {
        FStudent dLStudent = FactoryManage.GetStudent();
        ...
        {
            return dLStudent.Delete(hash, sqlWhere);
        }
        ...
        {
            return dLStudent.Select(pageSize, start, hash, out total, sqlWhere);
        }
        ...
        {
            return dLStudent.Select(hash, sqlWhere);
        }
